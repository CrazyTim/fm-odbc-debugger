...
#Region " Class TabPageCollection "
    ...
    Public Class TabPageCollection
        ...
        Public Function Add(ByVal Form As Form) As TabPage
            ...
            AddHandler TabPage.m_Form.TextChanged, AddressOf FormTextChanged 'added by jason
        ...
        Public Sub FormTextChanged() 'added by jason
            TabControl.TabToolTip.SetToolTip(SelectedTab, SelectedTab.m_Form.Text)
        End Sub
        ...
        Private Sub TabPage_Closed(ByVal sender As Object, ByVal e As EventArgs)
            Remove(sender)
            RaiseEvent SelectedChanged(sender, e) 'raise the event raises when we remove a tab
        End Sub
...
#End Region
    ...
    Public Sub New()
        ...
        AddHandler _pnlTabs.DoubleClick, AddressOf TabBackground_DoubleClick 'added by jason

    End Sub

    Public Sub TabBackground_DoubleClick(sender As Object, e As System.EventArgs) ' added by jason
    ...
    <Browsable(True), Category("Layout"), DefaultValue(FlowDirection.LeftToRight), Description("Gets or sets the direction which the tabs are drawn.")> _
