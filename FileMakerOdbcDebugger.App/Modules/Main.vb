...
Module Main
    ...
    Public ReadOnly StyleSyntax_Functions As New Regex("\b(ABS|ATAN|ATAN2|AVE|AVG|CAST|CEIL|CEILING|CHAR|CHR|CHARACTER_LENGTH|CHAR_LENGTH|COALESCE|CONVERT|COUNT|CURDATE|CURRENT_DATE|CURRENT_TIME|CURRENT_TIMESTAMP|CURRENT_USER|CURTIME|CURTIMESTAMP|DATE|DATEVAL|DAY|DAYNAME|DAYOFWEEK|DEG|DEGREES|EXP|FLOOR|HOUR|INT|LEFT|LENGTH|LOWER|LN|LOG|LTRIM|MAX|MIN|MINUTE|MOD|MONTH|MONTHNAME|NULLIF|NUMVAL|PI|PAD|RADIANS|RIGHT|ROUND|RTRIM|SECOND|SIGN|SIN|SPACE|SQRT|STRVAL|SUBSTR|SUBSTRING|SUM|TAN|TIMESTAMPVAL|TIMEVAL|TODAY|TRIM|UPPER|USER|USERNAME|YEAR)\b", RegexOptions.IgnoreCase Or RegexOptions.Compiled)
